...
<div class="p-2 mt-4">
  ...
  <div class="flex bg-white flex-wrap">
    <div class="p-1" v-for="texture in textureStore.paginatedTextures">
      <article class="border border-gray-500 rounded-xl p-1 w-30 flex flex-col">
  ...
  <div class="flex items-center justify-center text-center gap-5 text-lg">
    <button class="cursor-pointer" @click="textureStore.prevPage()">«PrevPage</button>
    <p>{{textureStore.currentPage}} of {{textureStore.totalPages}}</p>
    <button class="cursor-pointer" @click="textureStore.nextPage">NextPage»</button>
  </div>
