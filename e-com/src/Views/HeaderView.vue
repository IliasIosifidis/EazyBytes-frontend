...
<template>
  <div class="p-4 bg-gray-100 dark:bg-zinc-950 shadow-xl flex items-center font-bold justify-center gap-30 outline-1 outline-stone-300 dark:shadow-xl dark:shadow-purple-950 dark:text-purple-400 text-purple-700 dark:text-shadow-violet-100 text-shadow-violet-950 text-2xl">
<!--    Logo-->
...
<!--    Header Items-->
    <header class="cursor-pointer flex text-shadow-sm gap-15 justify-center">
...
<!--    Basket icon-->
    <div class="hover:transform hover:scale-120 duration-100 text-4xl cursor-pointer">
